		...
		return this.each(function() {	
			...
			$(this)[0].addEventListener('loadedmetadata', function() {
				...
				$( '<div class="player">'
				     ...
				     +'<div class="player-t"><i class="play-button fa fa-play-circle-o"></i></div>'
				     ...
				     + '<div class="progress">'
				       + '<div class="progress-bar">'
				         + '<div class="button-holder">'
				           + '<div class="progress-button"> </div><span class="ctime">00:00</span>'
				         + '</div>'
				       + '</div>'
				     + '</div><span class="ttime">00:00</span>'
				     + '<div class="volume">'
				...
				$that.find('.play-pause').bind('click', function() {
					...
					if($playing == false) {
						...
						$('.player-t').css('display') == 'none';
						bufferLength();
					} else {
						$begin = true;
						$spc.play();
						$('.player-t').css('display') == 'block';
